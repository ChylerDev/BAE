...
[`Generator`]: https://docs.rs/bae_rs/0.11.0/bae_rs/generators/trait.Generator.html
[`Modifier`]: https://docs.rs/bae_rs/0.11.0/bae_rs/modifiers/trait.Modifier.html
[`Sound`]: https://docs.rs/bae_rs/0.11.0/bae_rs/sounds/trait.Sound.html
[`SimpleSound`]: https://docs.rs/bae_rs/0.11.0/bae_rs/sounds/simple_sound/struct.SimpleSound.html
...
* [`petgrah`](https://crates.io/crates/petgraph): For the graph structure used by the [`ComplexSound`](https://docs.rs/bae_rs/0.11.0/bae_rs/sounds/complex_sound/struct.ComplexSound.html) struct.
